    ...
    public function getValue(): array
    {
        ...
        foreach ($data as $filter => $count) {
            ...
            $option = [
                ...
                'title_genetive' => __('filters.' . $filter),
                'title_accusative' => __('filters.' . $filter),
                'title_prepositional' => __('filters.' . $filter),
                'is_chosen' => false,
        ...
        return [
            Filters::PARAM_PROMOTION_GOODS => [
                ...
                'title_genetive' => __('filters.' . Filters::PARAM_PROMOTION_GOODS),
                'title_accusative' => __('filters.' . Filters::PARAM_PROMOTION_GOODS),
                'title_prepositional' => __('filters.' . Filters::PARAM_PROMOTION_GOODS),
