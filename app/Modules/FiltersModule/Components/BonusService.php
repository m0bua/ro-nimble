...
class BonusService extends BaseComponent
{
    ...
    public function getValue(): array
    {
        ...
        $with_bonus = [
            ...
            'title_genetive' => __('filters.' . Filters::PARAM_BONUS),
            'title_accusative' => __('filters.' . Filters::PARAM_BONUS),
            'title_prepositional' => __('filters.' . Filters::PARAM_BONUS),
        ...
        return [
            Filters::PARAM_BONUS => [
                ...
                'title_genetive' => __('filters.' . Filters::BONUS),
                'title_accusative' => __('filters.' . Filters::BONUS),
                'title_prepositional' => __('filters.' . Filters::BONUS),
